...
export const TIMER_BY_TURN_DEFAULT = 900;
export const TIMER_BY_PLAYER_DEFAULT = 12000;
export const TIMER_ADDITIONNAL_TIME_DEFAULT = 3000;
export const TIMER_BUFFER_TIME_DEFAULT = 150;
